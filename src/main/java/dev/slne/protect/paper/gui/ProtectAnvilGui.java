 ...
 */
public class ProtectAnvilGui extends ChestGui {
   ...
   */
  public ProtectAnvilGui(int rows, Component title) {
   ...
   * @return the list
   */
  public List<ProtectAnvilGui> walkParents() {
    List<ProtectAnvilGui> parents = new ArrayList<>();

    if (!(getParent() instanceof ProtectAnvilGui protectParent)) {
      return parents;
    }
