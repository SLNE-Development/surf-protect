package dev.slne.protect.paper.region.visual;
...
public class QuickHull {
	...
	public int pointLocation(Marker markerA, Marker markerB, Marker markerC) {
		int pointLocation = (markerB.getBlockX() - markerA.getBlockX()) * (markerC.getBlockZ() - markerA.getBlockZ())
				- (markerB.getBlockZ() - markerA.getBlockZ()) * (markerC.getBlockX() - markerA.getBlockX());
