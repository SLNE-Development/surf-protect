package dev.slne.protect.paper.region.settings;
...
public class ProtectionSettings {
  ...
  public static final String MARKES_WRITTEN = "acht";
   ...
   * The max distance a user is allowed to go from the protection start before being thrown back
   */
  public static final int MAX_DISTANCE_FROM_PROTECTION_START_SQUARED = 100 * 100;
  ...
  public static final String CURRENCY_NAME = "CastCoin";

  public static final int RANDOM_NAME_LENGTH = 5;
