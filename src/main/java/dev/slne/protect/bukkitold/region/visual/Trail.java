...
public class Trail extends BukkitRunnable {
   ...
   */
  public Trail(Marker markerStart, Marker markerEnd, ProtectionRegion protectionRegion,
  ...
  public void init() {
    ...
    this.increase = new Vector(end.getX() - this.startLocation.getX(),
        end.getY() - this.startLocation.getY(),
  ...
  private void doFrame() {
    ...
    world.spawnParticle(Particle.DUST, this.currentLocation.clone().add(0.5, 0.5, 0.5), 1,
        dustOptions);
  }
  ...
  public boolean equals(Object other) {
    ...
    return
        Objects.equals(markerStart, trail.markerStart) && Objects.equals(markerEnd, trail.markerEnd)
            || Objects.equals(markerStart, trail.markerEnd) && Objects.equals(markerEnd,
            trail.markerStart);
  }
