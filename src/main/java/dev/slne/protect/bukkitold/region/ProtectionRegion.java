...
import dev.slne.protect.bukkitold.gui.protection.flags.ProtectionFlagsMap;
import dev.slne.protect.bukkitold.math.Mth;
import dev.slne.protect.bukkitold.math.Mth.EffectiveCostResult;
import dev.slne.protect.bukkitold.message.MessageManager;
import dev.slne.protect.bukkitold.region.info.RegionCreationState;
...
import dev.slne.protect.bukkitold.region.transaction.ProtectionBuyData;
import dev.slne.protect.bukkitold.region.visual.Marker;
import dev.slne.protect.bukkitold.region.visual.QuickHull;
import dev.slne.protect.bukkitold.region.visual.Trail;
          ...
          if (!hasEnoughCurrency) {
            ...
            protectionUser.addTransaction(
              ...
              if (transactionAddResult != null && transactionAddResult.equals(
                ...
                Bukkit.getScheduler()
                    .runTask(BukkitMain.getInstance(), protectionUser::resetRegionCreation);
