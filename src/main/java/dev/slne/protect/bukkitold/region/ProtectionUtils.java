...
public class ProtectionUtils {
   ...
   */
  public static Map<World, List<Map.Entry<String, ProtectedRegion>>> getRegionsFor(
  ...
  /**
   * Tries to get a {@link RegionInfo} for a given {@link LocalPlayer} and regionName
   *
   * @param localPlayer the {@link LocalPlayer}
  ...
  public static RegionInfo getRegionInfo(LocalPlayer localPlayer, String regionName) {
    for (Map.Entry<World, List<Map.Entry<String, ProtectedRegion>>> entry : getRegionsFor(
        localPlayer).entrySet()) {
   ...
   */
  public static boolean doRegionsOverlap(World world, ProtectedRegion regionOne,
      ProtectedRegion regionTwo) {
  ...
  /**
   * Checks if the given {@link Player} currently stands in the given {@link ProtectedRegion}
   *
  ...
  /**
   * Gets a {@link ProtectedRegion} by {@link com.sk89q.worldedit.util.Location} without including
   * the {@link ProtectedRegion#GLOBAL_REGION}
   *
  ...
  /**
   * Returns the distance between a location and the teleport location of the given
   * {@link ProtectedRegion} if set
   *
